  ...
  return (
    <section className="m-[30px_0]">
      ...
      <div className="flex sm:flex-col flex-row items-center justify-between gap-[20px] shadow-[0px_0px_50px_-7px_rgba(0,_0,_0,_0.1)] p-[20px_20px]">
        ...
        <NavLink to={"purchases"} className="border text-[#A2A2A2] gap-3 rounded-[10px] w-[220px] h-[130px] p-[15px_10px]">
          <h1 className="text-[#0A8791] text-[24px] font-medium">
            Мои покупки
          </h1>
          <h2 className="text-[#FE585A] text-[40px] font-medium">0</h2>
        </NavLink>
        <NavLink to={"orders"} className="flex flex-col items-center gap-3 border text-[#A2A2A2] rounded-[10px] w-[350px] h-[130px] p-[15px_10px]">
          <h1 className="text-[#0A8791] text-[24px] font-medium">
            Статус текущих заказов
          </h1>
          <h2 className="text-[#FE585A] text-[40px] font-medium">0</h2>
        </NavLink>
        <NavLink to={"wishlist"} className="flex flex-col items-center gap-3 border text-[#A2A2A2] rounded-[10px] w-[220px] h-[130px] p-[15px_10px]">
          <h1 className="text-[#0A8791] text-[24px] font-medium">
            Сохраненные
          </h1>
